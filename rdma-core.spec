...
Version  : 22.1
Release  : 16
URL      : https://github.com/linux-rdma/rdma-core/releases/download/v22.1/rdma-core-22.1.tar.gz
Source0  : https://github.com/linux-rdma/rdma-core/releases/download/v22.1/rdma-core-22.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549463510
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libibumad.so.3.0.22.1
...
/usr/lib64/librdmacm.so.1.1.22.1
