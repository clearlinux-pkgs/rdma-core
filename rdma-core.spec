...
Version  : 15.1
Release  : 4
URL      : https://github.com/linux-rdma/rdma-core/archive/v15.1.tar.gz
Source0  : https://github.com/linux-rdma/rdma-core/archive/v15.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1511887026
mkdir clr-build
pushd clr-build
...
/usr/lib64/libibcm.so.1.0.15.1
/usr/lib64/libibumad.so.3
/usr/lib64/libibumad.so.3.0.15.1
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.1.15.1
...
/usr/lib64/libmlx4.so.1.0.15.1
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.2.15.1
/usr/lib64/librdmacm.so.1
/usr/lib64/librdmacm.so.1.0.15.1
