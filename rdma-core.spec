...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643305623
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rdma-core-39.0/COPYING.BSD_MIT %{buildroot}/usr/share/package-licenses/rdma-core/de66bb2ca6b007504c1844178dce4e48ef2adfff
cp %{_builddir}/rdma-core-39.0/COPYING.GPL2 %{buildroot}/usr/share/package-licenses/rdma-core/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/rdma-core-39.0/ccan/LICENSE.CCO %{buildroot}/usr/share/package-licenses/rdma-core/eaff686ba07863809da758bed796270f84c877ec
cp %{_builddir}/rdma-core-39.0/ccan/LICENSE.MIT %{buildroot}/usr/share/package-licenses/rdma-core/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
cp %{_builddir}/rdma-core-39.0/debian/copyright %{buildroot}/usr/share/package-licenses/rdma-core/a4cc693392f9a5a20fbb57c2818a1803b930c85b
cp %{_builddir}/rdma-core-39.0/providers/ipathverbs/COPYING %{buildroot}/usr/share/package-licenses/rdma-core/df75be21090fc8aa92d1175f31b7891432da3d09
pushd clr-build
%make_install
popd
...
/usr/lib64/libefa.so.1.1.39.0
/usr/lib64/libibmad.so.5
/usr/lib64/libibmad.so.5.3.39.0
/usr/lib64/libibnetdisc.so.5
/usr/lib64/libibnetdisc.so.5.0.39.0
/usr/lib64/libibumad.so.3
/usr/lib64/libibumad.so.3.2.39.0
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.14.39.0
...
/usr/lib64/libmlx4.so.1.0.39.0
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.22.39.0
