...
Source0  : https://github.com/linux-rdma/rdma-core/archive/v58.0/rdma-core-58.0.tar.gz
...
%prep
%setup -q -n rdma-core-58.0
cd %{_builddir}/rdma-core-58.0
pushd ..
cp -a rdma-core-58.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750084262
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libefa.so.1.3.58.0
/V3/usr/lib64/libhns.so.1.0.58.0
/V3/usr/lib64/libibmad.so.5.5.58.0
/V3/usr/lib64/libibnetdisc.so.5.1.58.0
/V3/usr/lib64/libibumad.so.3.4.58.0
/V3/usr/lib64/libibverbs.so.1.14.58.0
...
/V3/usr/lib64/libmana.so.1.0.58.0
/V3/usr/lib64/libmlx4.so.1.0.58.0
/V3/usr/lib64/libmlx5.so.1.25.58.0
/V3/usr/lib64/librdmacm.so.1.3.58.0
/V3/usr/lib64/rsocket/librspreload.so
/usr/lib64/ibacm/libibacmp.so
/usr/lib64/libefa.so.1
/usr/lib64/libefa.so.1.3.58.0
/usr/lib64/libhns.so.1
/usr/lib64/libhns.so.1.0.58.0
/usr/lib64/libibmad.so.5
/usr/lib64/libibmad.so.5.5.58.0
/usr/lib64/libibnetdisc.so.5
/usr/lib64/libibnetdisc.so.5.1.58.0
/usr/lib64/libibumad.so.3
/usr/lib64/libibumad.so.3.4.58.0
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.14.58.0
