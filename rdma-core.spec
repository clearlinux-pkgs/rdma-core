...
Version  : 19
Release  : 11
URL      : https://github.com/linux-rdma/rdma-core/releases/download/v19/rdma-core-19.tar.gz
Source0  : https://github.com/linux-rdma/rdma-core/releases/download/v19/rdma-core-19.tar.gz
...
Requires: rdma-core-license
Requires: rdma-core-man
BuildRequires : cmake
...
export LANG=C
export SOURCE_DATE_EPOCH=1530279017
mkdir clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1530279017
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/rdma-core
cp COPYING.GPL2 %{buildroot}/usr/share/doc/rdma-core/COPYING.GPL2
cp COPYING.BSD_MIT %{buildroot}/usr/share/doc/rdma-core/COPYING.BSD_MIT
cp COPYING.BSD_FB %{buildroot}/usr/share/doc/rdma-core/COPYING.BSD_FB
cp providers/ipathverbs/COPYING %{buildroot}/usr/share/doc/rdma-core/providers_ipathverbs_COPYING
cp debian/copyright %{buildroot}/usr/share/doc/rdma-core/debian_copyright
cp ccan/LICENSE.MIT %{buildroot}/usr/share/doc/rdma-core/ccan_LICENSE.MIT
cp ccan/LICENSE.CCO %{buildroot}/usr/share/doc/rdma-core/ccan_LICENSE.CCO
pushd clr-build
%make_install
popd
...
/usr/lib64/libibumad.so.3.0.19.0
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.1.19.0
/usr/lib64/libibverbs/libbnxt_re-rdmav19.so
/usr/lib64/libibverbs/libcxgb3-rdmav19.so
/usr/lib64/libibverbs/libcxgb4-rdmav19.so
/usr/lib64/libibverbs/libhfi1verbs-rdmav19.so
/usr/lib64/libibverbs/libhns-rdmav19.so
/usr/lib64/libibverbs/libi40iw-rdmav19.so
/usr/lib64/libibverbs/libipathverbs-rdmav19.so
/usr/lib64/libibverbs/libmlx4-rdmav19.so
/usr/lib64/libibverbs/libmlx5-rdmav19.so
/usr/lib64/libibverbs/libmthca-rdmav19.so
/usr/lib64/libibverbs/libnes-rdmav19.so
/usr/lib64/libibverbs/libocrdma-rdmav19.so
/usr/lib64/libibverbs/libqedr-rdmav19.so
/usr/lib64/libibverbs/librxe-rdmav19.so
/usr/lib64/libibverbs/libvmw_pvrdma-rdmav19.so
/usr/lib64/libmlx4.so.1
/usr/lib64/libmlx4.so.1.0.19.0
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.5.19.0
/usr/lib64/librdmacm.so.1
/usr/lib64/librdmacm.so.1.1.19.0
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/rdma-core/COPYING.BSD_FB
/usr/share/doc/rdma-core/COPYING.BSD_MIT
/usr/share/doc/rdma-core/COPYING.GPL2
/usr/share/doc/rdma-core/ccan_LICENSE.CCO
/usr/share/doc/rdma-core/ccan_LICENSE.MIT
/usr/share/doc/rdma-core/providers_ipathverbs_COPYING
