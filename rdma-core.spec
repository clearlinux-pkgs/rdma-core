...
Version  : 34.0
Release  : 37
URL      : https://github.com/linux-rdma/rdma-core/archive/v34.0/rdma-core-34.0.tar.gz
Source0  : https://github.com/linux-rdma/rdma-core/archive/v34.0/rdma-core-34.0.tar.gz
...
%prep
%setup -q -n rdma-core-34.0
cd %{_builddir}/rdma-core-34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614785838
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rdma-core-34.0/COPYING.BSD_FB %{buildroot}/usr/share/package-licenses/rdma-core/133cf03905c2dc7d8a061e1d6e9ced3117b0120f
cp %{_builddir}/rdma-core-34.0/COPYING.BSD_MIT %{buildroot}/usr/share/package-licenses/rdma-core/de66bb2ca6b007504c1844178dce4e48ef2adfff
cp %{_builddir}/rdma-core-34.0/COPYING.GPL2 %{buildroot}/usr/share/package-licenses/rdma-core/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/rdma-core-34.0/ccan/LICENSE.CCO %{buildroot}/usr/share/package-licenses/rdma-core/eaff686ba07863809da758bed796270f84c877ec
cp %{_builddir}/rdma-core-34.0/ccan/LICENSE.MIT %{buildroot}/usr/share/package-licenses/rdma-core/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
cp %{_builddir}/rdma-core-34.0/debian/copyright %{buildroot}/usr/share/package-licenses/rdma-core/6676f46ff6fa1ce65db1b3c8d729c71a400b36ff
cp %{_builddir}/rdma-core-34.0/providers/ipathverbs/COPYING %{buildroot}/usr/share/package-licenses/rdma-core/df75be21090fc8aa92d1175f31b7891432da3d09
pushd clr-build
%make_install
popd
...
/usr/lib64/libefa.so.1.1.34.0
/usr/lib64/libibmad.so.5
/usr/lib64/libibmad.so.5.3.34.0
/usr/lib64/libibnetdisc.so.5
/usr/lib64/libibnetdisc.so.5.0.34.0
/usr/lib64/libibumad.so.3
/usr/lib64/libibumad.so.3.2.34.0
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.12.34.0
...
/usr/lib64/libibverbs/libi40iw-rdmav34.so
...
/usr/lib64/libmlx4.so.1.0.34.0
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.18.34.0
