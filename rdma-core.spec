...
Version  : 53.0
Release  : 71
URL      : https://github.com/linux-rdma/rdma-core/archive/v53.0/rdma-core-53.0.tar.gz
Source0  : https://github.com/linux-rdma/rdma-core/archive/v53.0/rdma-core-53.0.tar.gz
...
%prep
%setup -q -n rdma-core-53.0
cd %{_builddir}/rdma-core-53.0
pushd ..
cp -a rdma-core-53.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723045687
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libefa.so.1.3.53.0
/V3/usr/lib64/libhns.so.1.0.53.0
/V3/usr/lib64/libibmad.so.5.3.53.0
/V3/usr/lib64/libibnetdisc.so.5.1.53.0
/V3/usr/lib64/libibumad.so.3.3.53.0
/V3/usr/lib64/libibverbs.so.1.14.53.0
...
/V3/usr/lib64/libmana.so.1.0.53.0
/V3/usr/lib64/libmlx4.so.1.0.53.0
/V3/usr/lib64/libmlx5.so.1.24.53.0
/V3/usr/lib64/librdmacm.so.1.3.53.0
/V3/usr/lib64/rsocket/librspreload.so
/usr/lib64/ibacm/libibacmp.so
/usr/lib64/libefa.so.1
/usr/lib64/libefa.so.1.3.53.0
/usr/lib64/libhns.so.1
/usr/lib64/libhns.so.1.0.53.0
/usr/lib64/libibmad.so.5
/usr/lib64/libibmad.so.5.3.53.0
/usr/lib64/libibnetdisc.so.5
/usr/lib64/libibnetdisc.so.5.1.53.0
/usr/lib64/libibumad.so.3
/usr/lib64/libibumad.so.3.3.53.0
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.14.53.0
...
/usr/lib64/libmana.so.1.0.53.0
/usr/lib64/libmlx4.so.1
/usr/lib64/libmlx4.so.1.0.53.0
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.24.53.0
/usr/lib64/librdmacm.so.1
/usr/lib64/librdmacm.so.1.3.53.0
