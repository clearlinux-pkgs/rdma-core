...
Version  : 56.1
Release  : 75
URL      : https://github.com/linux-rdma/rdma-core/archive/v56.1/rdma-core-56.1.tar.gz
Source0  : https://github.com/linux-rdma/rdma-core/archive/v56.1/rdma-core-56.1.tar.gz
...
%prep
%setup -q -n rdma-core-56.1
cd %{_builddir}/rdma-core-56.1
pushd ..
cp -a rdma-core-56.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743690662
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libefa.so.1.3.56.1
/V3/usr/lib64/libhns.so.1.0.56.1
/V3/usr/lib64/libibmad.so.5.5.56.1
/V3/usr/lib64/libibnetdisc.so.5.1.56.1
/V3/usr/lib64/libibumad.so.3.4.56.1
/V3/usr/lib64/libibverbs.so.1.14.56.1
...
/V3/usr/lib64/libmana.so.1.0.56.1
/V3/usr/lib64/libmlx4.so.1.0.56.1
/V3/usr/lib64/libmlx5.so.1.25.56.1
/V3/usr/lib64/librdmacm.so.1.3.56.1
/V3/usr/lib64/rsocket/librspreload.so
/usr/lib64/ibacm/libibacmp.so
/usr/lib64/libefa.so.1
/usr/lib64/libefa.so.1.3.56.1
/usr/lib64/libhns.so.1
/usr/lib64/libhns.so.1.0.56.1
/usr/lib64/libibmad.so.5
/usr/lib64/libibmad.so.5.5.56.1
/usr/lib64/libibnetdisc.so.5
/usr/lib64/libibnetdisc.so.5.1.56.1
/usr/lib64/libibumad.so.3
/usr/lib64/libibumad.so.3.4.56.1
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.14.56.1
...
/usr/lib64/libmana.so.1.0.56.1
/usr/lib64/libmlx4.so.1
/usr/lib64/libmlx4.so.1.0.56.1
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.25.56.1
/usr/lib64/librdmacm.so.1
/usr/lib64/librdmacm.so.1.3.56.1
