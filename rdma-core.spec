...
export LANG=C
export SOURCE_DATE_EPOCH=1520964315
mkdir clr-build
pushd clr-build
...
/usr/lib64/libibumad.so.3.0.17.1
...
/usr/lib64/libmlx4.so.1.0.17.1
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.4.17.1
/usr/lib64/librdmacm.so.1
/usr/lib64/librdmacm.so.1.1.17.1
