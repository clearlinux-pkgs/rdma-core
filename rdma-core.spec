...
Source0  : https://github.com/linux-rdma/rdma-core/releases/download/v24.0/rdma-core-24.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1559240547
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libefa.so.1.0.24.0
/usr/lib64/libibumad.so.3
/usr/lib64/libibumad.so.3.0.24.0
/usr/lib64/libibverbs.so.1
/usr/lib64/libibverbs.so.1.6.24.0
...
/usr/lib64/libibverbs/libefa-rdmav22.so
...
/usr/lib64/libmlx4.so.1.0.24.0
/usr/lib64/libmlx5.so.1
/usr/lib64/libmlx5.so.1.10.24.0
/usr/lib64/librdmacm.so.1
/usr/lib64/librdmacm.so.1.2.24.0
